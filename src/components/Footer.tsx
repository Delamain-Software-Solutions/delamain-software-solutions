const Footer = () => {
  return (
    <footer 
      className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-foreground py-16 overflow-hidden"
      style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            {/* <p className="text-muted-foreground mb-6 text-lg">
              Developed by AI, tested by professionals. We create cutting-edge software solutions that drive innovation and business growth.
            </p> */}
            <div className="flex space-x-4 mt-10 ms-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Desktop Software</a></li>
